...
namespace RLCTest
{
    ...
    public class Tests
    {
        ...
        {
            Goods food1 = new Goods("potato", Goods.REGULAR);
        ...
        {
            Goods food2 = new Goods("Orange", Goods.SALE);
        ...
        {
            Goods food3 = new Goods("Crab", Goods.SPECIAL_OFFER);
        ...
        {
            Goods food4 = new Goods("Aloe", Goods.REGULAR);
        ...
        {
            Goods food5 = new Goods("Milk", Goods.SALE);
        ...
        {
            Goods food5 = new Goods("Bread", Goods.SPECIAL_OFFER);
        ...
        {
            Goods food6 = new Goods("Fish", Goods.REGULAR);
